...
function ProjectCard({ project }) {
  return (
    <FadeInOnScroll>
      <div className="w-full h-full rounded-[35px] bg-white shadow-md border border-[#c1c1c1] p-6 text-center cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#f3f3f3] custom-meriva flex flex-col group hover:scale-105">
